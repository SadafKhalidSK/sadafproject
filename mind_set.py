...
st.title("Transform your files between CSV and Excel formats with built-in data cleaning and visualization Creating the project for quataer 3!")
...
if uploaded_files:
    for file in uploaded_files:
        file_ext = os.path.splittext(file.name)else:[-1].lower()
        ...
        if st.button(f"Convert{file.name}"):
            ...
            if conversion_type == "CVS":
                ...
                mime_type="application/vnd.openxmlformats-officedocument.spreadseetml.sheet"
            buffer_seek=(0)
